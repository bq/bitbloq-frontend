...
angular
  ...
  .factory(
    "borndate",
    function (alertsService, web2board, $q, $translate, projectService) {
      var knownBoards = {
        zumjunior: {
          ...
          libraries: [
            ...
            {
              zipURL: "/libraries/BitbloqSoftwareSerial.zip",
              precompiled: true,
            },
        ...
        zumcore2: {
          ...
          libraries: [
            ...
            {
              zipURL: "/libraries/BitbloqLiquidCrystal.zip",
              precompiled: true,
            },
      ...
      function callCompiler(params) {
        ...
        if (
          projectService.project.hardware.robot === "evolution" ||
        ...
        if (projectService.project.hardware.board === "mcore") {
          libraries = libraries.concat([
            ...
            {
              zipURL: "/libraries/BitbloqMBotDeprecated.zip",
              precompiled: true,
            },
            { zipURL: "/libraries/EEPROM.zip", precompiled: true },
          ]).filter(function (lib) {
